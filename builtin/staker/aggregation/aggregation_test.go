...
func TestAggregation(t *testing.T) {
	...
	agg.body.Locked.VET = uint64(10000)
	agg.body.Locked.Weight = uint64(20000)
	agg.body.Pending.VET = uint64(9000)
	agg.body.Pending.Weight = uint64(18000)
	agg.body.Exiting.VET = uint64(8000)
	agg.body.Exiting.Weight = uint64(16000)
	...
	agg.body.Pending.VET = uint64(7000)
	agg.body.Pending.Weight = uint64(14000)
