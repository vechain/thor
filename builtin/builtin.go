...
func (e *energyContract) Native(state *state.State, blockTime uint64, stopTimeFunc energy.StopTimeFunc) *energy.Energy {
	return energy.New(e.Address, state, blockTime, stopTimeFunc, Params.Native(state))
}
