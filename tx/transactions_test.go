...
func TestRootHash(t *testing.T) {
	...
	test := []struct {
		...
		},
		{
			...
			txs:            tx.Transactions{GetMockTx(tx.LegacyTxType), GetMockTx(tx.LegacyTxType)},
		...
		},
		{
			...
			txs:            tx.Transactions{GetMockTx(tx.DynamicFeeTxType), GetMockTx(tx.DynamicFeeTxType)},
		...
		},
		{
			...
			txs:            tx.Transactions{GetMockTx(tx.LegacyTxType), GetMockTx(tx.DynamicFeeTxType), GetMockTx(tx.DynamicFeeTxType), GetMockTx(tx.LegacyTxType)},
