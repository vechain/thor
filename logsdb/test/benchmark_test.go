...
func BenchmarkComparative_FilterEvents(b *testing.B) {
	...
	tests := []struct {
		...
		// Range + intersection combos (realistic blockchain query patterns)
		{"RangeAndAddress", &logsdb.EventFilter{CriteriaSet: rangeAndAddressCriteria, Range: &logsdb.Range{From: 100000, To: 200000}, Options: &logsdb.Options{Offset: 0, Limit: 500000}}},
		{"RangeAndAddressAndTopic", &logsdb.EventFilter{CriteriaSet: rangeAndAddressAndTopicCriteria, Range: &logsdb.Range{From: 100000, To: 200000}, Options: &logsdb.Options{Offset: 0, Limit: 500000}}},
		{"RangeAndMultiTopic", &logsdb.EventFilter{CriteriaSet: rangeAndMultiTopicCriteria, Range: &logsdb.Range{From: 100000, To: 200000}, Options: &logsdb.Options{Offset: 0, Limit: 500000}}},
		{"RangeAndComplex", &logsdb.EventFilter{CriteriaSet: rangeAndComplexCriteria, Range: &logsdb.Range{From: 100000, To: 200000}, Options: &logsdb.Options{Offset: 0, Limit: 500000}}},
		{"RangeAndStressTest", &logsdb.EventFilter{CriteriaSet: rangeAndStressTestCriteria, Range: &logsdb.Range{From: 100000, To: 200000}, Options: &logsdb.Options{Offset: 0, Limit: 500000}}},
	}
...
func BenchmarkComparative_FilterTransfers(b *testing.B) {
	...
	tests := []struct {
		...
		{"TransferCriteriaDesc", &logsdb.TransferFilter{Order: logsdb.DESC, CriteriaSet: transferCriteria, Options: &logsdb.Options{Offset: 0, Limit: 500_000}}},
