...
func (t *rlpx) doEncHandshake(prv *ecdsa.PrivateKey, dial *tempdiscv5.Node) (tempdiscv5.NodeID, error) {
	var (
		sec secrets
		err error
	)
...
func initiatorEncHandshake(conn io.ReadWriter, prv *ecdsa.PrivateKey, remoteID tempdiscv5.NodeID) (s secrets, err error) {
