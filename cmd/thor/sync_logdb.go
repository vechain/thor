...
func syncLogDB(ctx context.Context, repo *chain.Repository, logDB logsdb.LogDB, verify bool) error {
...
func seekLogDBSyncPosition(repo *chain.Repository, logDB logsdb.LogDB) (uint32, error) {
...
func verifyLogDB(ctx context.Context, endBlockNum uint32, repo *chain.Repository, logDB logsdb.LogDB) error {
