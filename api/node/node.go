...
func New(nw types.Network, pool *txpool.TxPool, enableTxpool bool) *Node {
	return &Node{
		pool,
		nw,
		enableTxpool,
...
func (n *Node) PeersStats() []*types.PeerStats {
	return types.ConvertPeersStats(n.nw.PeersStats())
}
