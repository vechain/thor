...
var _ logdb.LogDB = (*PebbleV3LogDB)(nil)

// PebbleV3LogDB implements logdb.LogDB interface using PebbleDB v3 streaming architecture
type PebbleV3LogDB struct {
	db          *pebble.DB
	path        string
...
func Open(path string) (*PebbleV3LogDB, error) {
...
func OpenForBulkLoad(path string) (*PebbleV3LogDB, error) {
...
func openWithOptions(path string, opts *pebble.Options) (*PebbleV3LogDB, error) {
...
func (p *PebbleV3LogDB) Close() error {
	return p.db.Close()
}

// NewWriter creates a new writer instance
func (p *PebbleV3LogDB) NewWriter() logdb.Writer {
	return NewPebbleV3Writer(p.db)
}

// NewBulkWriter creates a writer optimized for bulk loading/migration
func (p *PebbleV3LogDB) NewBulkWriter() logdb.Writer {
...
func (p *PebbleV3LogDB) NewWriterSyncOff() logdb.Writer {
	return p.NewWriter()
}

// Path returns the database path
func (p *PebbleV3LogDB) Path() string {
	return p.path
}

// NewestBlockID returns the newest written block ID
func (p *PebbleV3LogDB) NewestBlockID() (thor.Bytes32, error) {
...
func (p *PebbleV3LogDB) HasBlockID(blockID thor.Bytes32) (bool, error) {
...
func (p *PebbleV3LogDB) FilterEvents(ctx context.Context, filter *logdb.EventFilter) ([]*logdb.Event, error) {
	if filter == nil {
...
func (p *PebbleV3LogDB) FilterTransfers(ctx context.Context, filter *logdb.TransferFilter) ([]*logdb.Transfer, error) {
	if filter == nil {
		return nil, errors.New("filter is required")
	}
