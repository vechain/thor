...
// PrecompiledContractsFusaka contains the default set of pre-compiled contracts
// used in the VeChain INTERSTELLAR fork.
// INTERSTELLAR is the VeChain umbrella covering Dencun (EIP-5656), Pectra and Osaka EVM changes.
// Osaka introduces EIP-7883 (ModExp gas cost increase).
var PrecompiledContractsFusaka = map[common.Address]PrecompiledContract{
	common.BytesToAddress([]byte{1}): &safeEcrecover{},
	common.BytesToAddress([]byte{2}): &sha256hash{},
	common.BytesToAddress([]byte{3}): &ripemd160hash{},
	common.BytesToAddress([]byte{4}): &dataCopy{},
	common.BytesToAddress([]byte{5}): &bigModExp{eip2565: true, eip7883: true},
	common.BytesToAddress([]byte{6}): &bn256Add{eip1108: true},
	common.BytesToAddress([]byte{7}): &bn256ScalarMul{eip1108: true},
	common.BytesToAddress([]byte{8}): &bn256Pairing{eip1108: true},
	common.BytesToAddress([]byte{9}): &blake2F{},
...
var (
	PrecompiledAddressesFusaka    []common.Address
