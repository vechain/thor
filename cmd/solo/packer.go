...
func (p *SoloPacker) Prepare(parent *block.Header, newBlockTimestamp uint64) (
	...
	var (
		...
		rt           = runtime.New(state, p.beneficiary, parent.Number()+1, newBlockTimestamp, gasLimit, func(num uint32) thor.Hash {
...
func (p *SoloPacker) newTxFinder(parentBlockID thor.Hash, processed map[thor.Hash]struct{}) func(txID thor.Hash) (bool, error) {
