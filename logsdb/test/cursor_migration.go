...
func resolveTransferReferences(db *sql.DB, transfer *logsdb.Transfer, blockIDRef, txIDRef, txOriginRef, senderRef, recipientRef int64) error {
...
func ReconfigurePebbleForProduction(pebblePath string) (*pebbledb.PebbleLogsDB, error) {
...
func MigrateWithFullOptimization(sqlitePath, pebblePath string, verify bool) (*pebbledb.PebbleLogsDB, *MigrationStats, error) {
