...
contract Staker {
     ...
     */
    function totalStake() public view returns (uint256 totalValStake, uint256 totalWeight) {
     ...
     */
    function queuedStake() public view returns (uint256 queuedValStake, uint256 queuedWeight) {
    ...
    function getValidation(
        ...
        returns (
            ...
            uint256 stake,
            uint256 weight,
            uint256 queuedValStake,
            uint8 status,
            uint32 offlineBlock
        )
    {
        (endorser, stake, weight, queuedValStake, status, offlineBlock, , , , ) = StakerNative(
            address(this)
        ).native_getValidation(validator);
        return (endorser, stake, weight, queuedValStake, status, offlineBlock);
    }
     ...
     */
    function firstActive() public view returns (address firstActiveVal) {
     ...
     */
    function firstQueued() public view returns (address firstQueuedVal) {
