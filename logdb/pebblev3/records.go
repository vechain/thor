...
// ToLogDBEvent converts EventRecord to logdb.Event
func (er *EventRecord) ToLogDBEvent() *logdb.Event {
...
// NewEventRecord creates EventRecord from logdb.Event
func NewEventRecord(event *logdb.Event) *EventRecord {
...
// ToLogDBTransfer converts TransferRecord to logdb.Transfer
func (tr *TransferRecord) ToLogDBTransfer() *logdb.Transfer {
	return &logdb.Transfer{
		BlockID:     tr.BlockID,
...
// NewTransferRecord creates TransferRecord from logdb.Transfer
func NewTransferRecord(transfer *logdb.Transfer) *TransferRecord {
