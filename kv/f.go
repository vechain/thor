...
type (
	...
	KeyFunc         func() []byte
	ValueFunc       func() []byte
	DeleteRangeFunc func(ctx context.Context, rng Range) (int, error)
)
...
func (f DeleteRangeFunc) DeleteRange(ctx context.Context, rng Range) (int, error) { return f(ctx, rng) }
