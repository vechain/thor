...
var _ logdb.Writer = (*PebbleV3Writer)(nil)

// PebbleV3Writer implements logdb.Writer interface for PebbleDB v3
...
func (w *PebbleV3Writer) WriteMigrationEvents(events []*logdb.Event) error {
...
func (w *PebbleV3Writer) WriteMigrationTransfers(transfers []*logdb.Transfer) error {
