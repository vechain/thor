...
var _ logsdb.LogsDB = (*PebbleLogsDB)(nil)

// PebbleLogsDB implements logsdb.LogDB interface using PebbleDB v3 streaming architecture
type PebbleLogsDB struct {
	db          *pebble.DB
	path        string
...
func Open(path string) (*PebbleLogsDB, error) {
...
func OpenForBulkLoad(path string) (*PebbleLogsDB, error) {
...
func openWithOptions(path string, opts *pebble.Options) (*PebbleLogsDB, error) {
...
func (p *PebbleLogsDB) Close() error {
	return p.db.Close()
}

// NewWriter creates a new writer instance
func (p *PebbleLogsDB) NewWriter() logsdb.Writer {
	return NewPebbleV3Writer(p.db)
}

// NewBulkWriter creates a writer optimized for bulk loading/migration
func (p *PebbleLogsDB) NewBulkWriter() logsdb.Writer {
...
func (p *PebbleLogsDB) NewWriterSyncOff() logsdb.Writer {
	return p.NewWriter()
}

// Path returns the database path
func (p *PebbleLogsDB) Path() string {
	return p.path
}

// NewestBlockID returns the newest written block ID
func (p *PebbleLogsDB) NewestBlockID() (thor.Bytes32, error) {
...
func (p *PebbleLogsDB) HasBlockID(blockID thor.Bytes32) (bool, error) {
...
func (p *PebbleLogsDB) FilterEvents(ctx context.Context, filter *logsdb.EventFilter) ([]*logsdb.Event, error) {
	if filter == nil {
...
func (p *PebbleLogsDB) FilterTransfers(ctx context.Context, filter *logsdb.TransferFilter) ([]*logsdb.Transfer, error) {
	if filter == nil {
		return nil, errors.New("filter is required")
	}
