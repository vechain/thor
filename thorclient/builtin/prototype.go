...
func (p *Prototype) Master(contract thor.Address) (thor.Address, error) {
	...
	if err := p.contract.Operation("master", contract).Call().Into(&out); err != nil {
...
func (p *Prototype) SetMaster(self thor.Address, newMaster thor.Address) bind.OperationBuilder {
	return p.contract.Operation("setMaster", self, newMaster)
}
...
func (p *Prototype) IsUser(self thor.Address, user thor.Address) (bool, error) {
	out := new(bool)
	if err := p.contract.Operation("isUser", self, user).Call().Into(&out); err != nil {
		return false, err
	}
	return *out, nil
}
...
func (p *Prototype) AddUser(self thor.Address, user thor.Address) bind.OperationBuilder {
	return p.contract.Operation("addUser", self, user)
}

// RemoveUser removes a user from the contract
func (p *Prototype) RemoveUser(self thor.Address, user thor.Address) bind.OperationBuilder {
	return p.contract.Operation("removeUser", self, user)
}
...
func (p *Prototype) UserCredit(self thor.Address, user thor.Address) (*big.Int, error) {
	out := new(big.Int)
	if err := p.contract.Operation("userCredit", self, user).Call().Into(&out); err != nil {
		return nil, err
	}
	return out, nil
}
...
func (p *Prototype) CreditPlan(self thor.Address) (*big.Int, *big.Int, error) {
	...
	out[0] = new(*big.Int)
	out[1] = new(*big.Int)
	if err := p.contract.Operation("creditPlan", self).Call().Into(&out); err != nil {
		return nil, nil, err
	}
...
func (p *Prototype) SetCreditPlan(self thor.Address, credit *big.Int, recoveryRate *big.Int) bind.OperationBuilder {
	return p.contract.Operation("setCreditPlan", self, credit, recoveryRate)
}

// CurrentSponsor returns the current sponsor address
func (p *Prototype) CurrentSponsor(self thor.Address) (thor.Address, error) {
	out := new(common.Address)
	if err := p.contract.Operation("currentSponsor", self).Call().Into(&out); err != nil {
		return thor.Address{}, err
	}
	return thor.Address(*out), nil
}
...
func (p *Prototype) IsSponsor(self thor.Address, sponsor thor.Address) (bool, error) {
	out := new(bool)
	if err := p.contract.Operation("isSponsor", self, sponsor).Call().Into(&out); err != nil {
		return false, err
	}
	return *out, nil
}
...
func (p *Prototype) SelectSponsor(self thor.Address, sponsor thor.Address) bind.OperationBuilder {
	return p.contract.Operation("selectSponsor", self, sponsor)
}

// Sponsor sponsors the contract
func (p *Prototype) Sponsor(self thor.Address) bind.OperationBuilder {
	return p.contract.Operation("sponsor", self)
}

// Unsponsor removes sponsorship from the contract
func (p *Prototype) Unsponsor(self thor.Address) bind.OperationBuilder {
	return p.contract.Operation("unsponsor", self)
}
...
func (p *Prototype) Balance(self thor.Address, blockNumber *big.Int) (*big.Int, error) {
	out := new(big.Int)
	if err := p.contract.Operation("balance", self, blockNumber).Call().Into(&out); err != nil {
		return nil, err
	}
	return out, nil
}
...
func (p *Prototype) Energy(self thor.Address, blockNumber *big.Int) (*big.Int, error) {
	out := new(big.Int)
	if err := p.contract.Operation("energy", self, blockNumber).Call().Into(&out); err != nil {
		return nil, err
	}
	return out, nil
}
...
func (p *Prototype) HasCode(self thor.Address) (bool, error) {
	out := new(bool)
	if err := p.contract.Operation("hasCode", self).Call().Into(&out); err != nil {
		return false, err
	}
	return *out, nil
}
...
func (p *Prototype) StorageFor(self thor.Address, key thor.Bytes32) (thor.Bytes32, error) {
	out := new(common.Hash)
	if err := p.contract.Operation("storageFor", self, key).Call().Into(out); err != nil {
