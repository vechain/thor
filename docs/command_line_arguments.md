...
| `--logdb-additional-indexes`     | Creates additional indexes on startup, only effective when --skip-logs is not enabled. Enabling this option can cause slow first startup |
