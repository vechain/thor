...
//go:generate docker run -v ./:/sources ethereum/solc:0.8.20 --evm-version paris --optimize --optimize-runs 200 -o /sources/compiled --abi --bin-runtime /sources/staker.sol
