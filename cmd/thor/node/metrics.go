...
var (
	...
	metricTotalScoreGauge         = metrics.LazyLoadGauge("total_score")
	metricBestBlockGauge          = metrics.LazyLoadGauge("best_block_number")
	metricBestBlockTimestampGauge = metrics.LazyLoadGauge("best_block_timestamp")
